...
part of 'profile.remote.services.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ProfileAbsentParams _$ProfileAbsentParamsFromJson(Map<String, dynamic> json) =>
    ProfileAbsentParams(
      json['uid'] as String?,
...
Map<String, dynamic> _$ProfileAbsentParamsToJson(
        ProfileAbsentParams instance) =>
    <String, dynamic>{
      'uid': instance.uid,
  ...
  Future<HttpResponse<dynamic>> addressInfo(
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'http://182.23.67.40:8083/officeapi/API/user/address/${uid}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<dynamic>> educationInfo(
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'http://182.23.67.40:8083/officeapi/API/user/edu/${uid}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<dynamic>> familyInfo(
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'http://182.23.67.40:8083/officeapi/API/user/family/${uid}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<dynamic>> jobInfo(
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'http://182.23.67.40:8083/officeapi/API/user/job/${uid}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<dynamic>> emCtcInfo(
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'http://182.23.67.40:8083/officeapi/API/user/emcontact/${uid}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<dynamic>> payrollInfo(
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'http://182.23.67.40:8083/officeapi/API/user/infopayroll/${uid}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
